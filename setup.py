...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-trytond-scrap',
    download_url='https://github.com:nantic/trytond-trytond-scrap.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-trytond-scrap.git'
    },
    classifiers=[
